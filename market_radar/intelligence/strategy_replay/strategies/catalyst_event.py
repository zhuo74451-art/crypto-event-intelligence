"""Catalyst event strategy — exploratory. Catalyst event strategy"""
...
def get_strategy_definition() -> StrategyDefinitionV1:
    return StrategyDefinitionV1(
        strategy_id="strat_catalyst_event",
        strategy_version="1.0.0",
        strategy_family="catalyst_event",
        strategy_name="Catalyst Event Strategy",
        supported_event_families=["catalyst_event"],
