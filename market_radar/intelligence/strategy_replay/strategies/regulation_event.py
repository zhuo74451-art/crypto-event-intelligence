"""Regulation event strategy — exploratory. Regulation event strategy"""
...
def get_strategy_definition() -> StrategyDefinitionV1:
    return StrategyDefinitionV1(
        strategy_id="strat_regulation_event",
        strategy_version="1.0.0",
        strategy_family="regulation_event",
        strategy_name="Regulation Event Strategy",
        supported_event_families=["regulation_event"],
